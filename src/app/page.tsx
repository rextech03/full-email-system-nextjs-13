  ...
  return (
    <>
     ...
     <section id="banner">
      ...
      <div className="h-full w-full max-sm:px-2  lg:px-20 flex justify-center items-center">

      <div className=" max-sm:px-4 my-4 md:flex md:justify-between md:px-20 md:gap-8 lg:px-20 max-2xl:px-96 2xl:px-60 ">
